...
const DialogSlide11 = React.forwardRef((props, ref) => {
  ...
  const handleUpadateSchoolStatus = async () => {
    // console.log(props)
    let schoolStatus = props.stat;
    let schoolId = props.schlId;
    const res = await instance({
      url: `school/admin/status/update/${schoolId}`,
      method: "PUT",
      data: {
        status: !schoolStatus,
      },
