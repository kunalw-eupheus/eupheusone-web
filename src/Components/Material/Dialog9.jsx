...
const DialogSlide9 = React.forwardRef((props, ref) => {
  ...
  const getInvoiceDetails = async () => {
    ...
    const res = await instance({
      url: `ckOrders/getckorders/${props.invoiceId}`,
      method: "GET",
      headers: {
    ...
    if (res.data.status === "success") {
      ...
      // formik.values.BillFrom =
        ...
        setBillFrom(res.data.message[0].ck_orders_addresses[0].BillFromName)
      // formik.values.BillTo =
        // res.data.message[0].ck_invoice_addresses[0].BillToName;
        setBillTo(res.data.message[0].ck_orders_addresses[0].BillToName)
      ...
      // formik.values.DispatchFrom =
        ...
        setDispatchFrom(res.data.message[0].ck_orders_addresses[0].DispatchFromAddress1)
      // formik.values.ShipsTo =
      //   res.data.message[0].ck_invoice_addresses[0].ShipToAddress1;

        setShipsTo(res.data.message[0].ck_orders_addresses[0].ShipToAddress1)

      // setInvoiceDetails(res.data.message);
      setInvoiceItems(res.data.message[0].ck_orders_items);
